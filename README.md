Flappy Swipe - A demonstration of "Playable Ads"
=================================================
This is a demo of "playable ads" where brand components are built into the game itself to increase app user engagement while achieving brand recall.

This demo game will be embedded at swipecrypto telegram chatroom for demonstration.


Live App
------------
Check out a live preview of it over here:  
http://swipecrypto.github.io/telegramflap/
